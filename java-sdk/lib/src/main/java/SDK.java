...
public class SDK {
     ...
     * 
    **/
    public .models.operations.PostTrackResponse postTrack(.models.operations.PostTrackRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = .utils.Utils.generateURL(baseUrl, "/track/");
        ...
        .models.operations.PostTrackResponse res = new .models.operations.PostTrackResponse() {{
            eventsCaptureResponse = null;
        }};
        ...
        if (httpRes.statusCode() == 200) {
            if (.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                .models.shared.EventsCaptureResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), .models.shared.EventsCaptureResponse.class);
